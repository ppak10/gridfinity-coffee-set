...
difference() {
    gridfinityInit(2, 2, height(6), 0, 42) {
        cutCylinders(1, cylinder_diameter=79.75, orientation=90, cylinder_height=0.5, chamfer=0.5);
    }
    hull(){
        translate([0, 0, 44]) cylinder(0.1, 79.75/2, true);
        translate([0, 0, 6]) cylinder(0.1, 79.75/2, true);
    }
}
