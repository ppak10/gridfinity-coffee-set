...
difference() {
    gridfinityInit(2, 2, height(6), 0, 42) {
        cutCylinders(1, cylinder_diameter=64.25, orientation=90, cylinder_height=0.5, chamfer=0.5);
    }
    hull(){
        translate([0, 0, 44]) cylinder(0.1, 65/2, true);
        translate([0, 0, 6]) cylinder(0.1, 56.5/2, true);
    }
}
